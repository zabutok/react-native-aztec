...
import AztecViewNativeComponent from './AztecViewNativeComponent';
import {
  BACKSPACE,
  DELETE,
  DOWN,
...
const AztecManager =  UIManager.getViewManagerConfig( isAndroid ? 'AztecView' : 'RCTAztecView' );
...
const RCTAztecView = isAndroid ? AztecViewNativeComponent : requireNativeComponent( 'RCTAztecView', AztecView );
